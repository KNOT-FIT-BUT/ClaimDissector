...
def get_raw_scores(examples, preds):
    ...
    for example in examples:
        ...
        predicted_sp = prediction['all_predicted_evidence']
        
        # pred_titles = []
        # for doc_idx in prediction:
        #     pred_titles.append(all_titles[doc_idx])

        exact_scores[uid] = compute_exact(supporting_facts, predicted_sp)
        f1_scores[uid] = compute_f1(supporting_facts, predicted_sp)
