...
"""
Evaluates and writes out results for conflicting REALFC samples, you can find those in .results/realfc_lrm_verifier_{log_results}"
"""
BLOCK_SIZE = 500
# MODELS = [
#     "realfc_verifier_A0.7891_S0.5883_B_500_S12000_M.saved_pretrained_debertav3_base_mnli_2023-02-06_21:34_athena21",
#     "realfc_verifier_A0.7963_S0.5901_B_500_S12000_M.saved_pretrained_debertav3_base_mnli_2023-02-07_23:23_athena21",
#     "realfc_verifier_A0.7997_S0.5937_B_500_S15000_M.saved_pretrained_debertav3_base_mnli_2023-02-08_16:39_athena21",
#     "realfc_verifier_A0.7840_S0.5790_B_500_S13000_M.saved_pretrained_debertav3_base_mnli_2023-02-09_05:00_athena21",
#     "realfc_verifier_A0.8006_S0.5912_B_500_S12736_M.saved_pretrained_debertav3_base_mnli_2023-02-09_18:55_athena21",
# ]
config = {
    ...
    "test_only": True,
    "model": ".saved/best/realfc_verifier_A0.7997_S0.5937_B_500_S15000_M.saved_pretrained_debertav3_base_mnli_2023-02-08_16:39_athena21",
    ...
    "skip_allneutral_sections": True,
    "skip_nonconflicting_evidence": True,
    # These are not interesting for word-level relevance judgement , as they do not contain anything relevant
    "log_results": "deberta-base_conflicting",
    "log_total_results": 500,
