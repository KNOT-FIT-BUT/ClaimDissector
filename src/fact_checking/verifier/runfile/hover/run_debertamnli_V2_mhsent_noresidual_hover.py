...
"""
Trains our DeBERTa-v3-base based Claim-Dissector on HOVER dataset.

Warning: the performance achieved by this experiment runs under simplified conditions (as described in the paper), this includes:
1. validation with cheating (inputs are infused with GT documents) achieving RaI 100%
2. # of prediced documents is same as number of ground truth documents (if there are 4 annotated sentences, we pick top-4 sentences)

Observing model struggling with multidocument hopping, DebertaV3 architecture may not be ideal for this kind of problem.
We assume a long-input architecture, or an iterative architecture may be necessary to make CD work well here.
Due to different nature of experiments, non-aligned with our goals, we discontinued this line of experiments further.
"""
BLOCK_SIZE = 500
config = {
    ...
    # Data
    ###############################
    "data_cache_dir": ".data/HOVER/verifier/preprocessed",
    "dataset": "hover",
    # "train_data": {
    #     "retrieval": ".data/HOVER/verifier/article_level/baleen_inference_100x4_ordered/output_separate_deduplists_train.json",
    #     "retrieval_inputs": ".data/HOVER/baleen_retrieval/train/qas.jsonl",
    #     "official": ".data/HOVER/official/hover_train_release_v1.1.json",
    # },
    # "val_data": {
    #     "retrieval": ".data/HOVER/verifier/article_level/baleen_inference_100x4_ordered/output_separate_deduplists_dev.json",
    #     "retrieval_inputs": ".data/HOVER/baleen_retrieval/dev/qas.jsonl",
    #     "official": ".data/HOVER/official/hover_dev_release_v1.1.json",
    # },
    # "test_data": {
    #     "retrieval": ".data/HOVER/verifier/article_level/baleen_inference_100x4_ordered/output_separate_deduplists_test.json",
    #     "retrieval_inputs": ".data/HOVER/baleen_retrieval/test/qas.jsonl",
    #     "official": ".data/HOVER/official/hover_test_release_v1.1.json",
    # },
    "train_data": {
        "retrieval": ".data/HOVER/verifier/article_level/baleen_inference_25x4_ordered/output_separate_deduplists_train.json",
        "retrieval_inputs": ".data/HOVER/baleen_retrieval/train/qas.jsonl",
        "official": ".data/HOVER/official/hover_train_release_v1.1.json",
    },
    "val_data": {
        "retrieval": ".data/HOVER/verifier/article_level/baleen_inference_25x4_ordered/output_separate_deduplists_dev.json",
        "retrieval_inputs": ".data/HOVER/baleen_retrieval/dev/qas.jsonl",
        "official": ".data/HOVER/official/hover_dev_release_v1.1.json",
    },
    # "test_data": {
    #     "retrieval": ".data/HOVER/verifier/article_level/baleen_inference_25x4_unordered/output_test.json",
    #     "retrieval_inputs": ".data/HOVER/baleen_retrieval/test/qas.jsonl",
    #     "official": ".data/HOVER/official/hover_test_release_v1.1.json",
    # },
    "pass_database": f".index/HOVER_wikipages/hoverwiki_blocks_{BLOCK_SIZE}.db",
    # "pass_database": f".index/HOVER_wikipages/hoverwiki_blocks_{BLOCK_SIZE}_reparsed.db",
    ...
    "save_threshold": 0.2,  # save up some q space
    ...
    # random, golden_passage_only, non_golden_passage_only, equal_golden_nongolden_mixture, random_golden_nongolden_mixture,jiangetal_sup
    "sentence_relevance_negative_ss": "random_golden_nongolden_mixture",
    ...
    "balance_weights": [1., 11_023 / 7_148],

    ### DEBUG
    # "log_total_results": 100,
    # "dump_positives_negatives": True,
    "xtimesneg": 1000,  # USE ALL NEGS
}
