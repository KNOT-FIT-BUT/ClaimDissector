...
"""
This is the masker model, our baseline for computing the token-level relevances
"""
BLOCK_SIZE = 500
config = {
    ...
    "train_masker": {
        "pretrained_model": ".checkpoints/verifier_A0.7998_S0.7652_R0.9145_B_500_S12500_M.saved_pretrained_debertav3_base_mnli_2022-06-02_00:23_acn66.karolina.it4i.cz",
        "top_k": -1,
        "sparsity_weight": 3.,
