...
"""
This script trains claim-dissector with paragraph supervision only, while validating on sentence-level supervision.
"""
BLOCK_SIZE = 500
config = {
    ...
    # "resume_checkpoint": "verifier_A0.7827_S0.6578_R0.7576_B_500_S4000_M.saved_pretrained_debertav3_base_mnli_2022-06-03_08:00_acn69.karolina.it4i.cz",
    ...
    "hard_paragraph_supervision": {
        "start_after": 1_000,
        "interpolate_until": 3_000,
        "true_hardem": True,  # this will maximize only one sentence and minimize others in block,
        "stochastic_em": True,  # instead of argmax, sample proportionally to in-block probability mass
    },
