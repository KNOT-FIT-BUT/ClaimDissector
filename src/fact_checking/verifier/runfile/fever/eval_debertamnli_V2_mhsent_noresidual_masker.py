...
"""
Evaluate the masker model on TLR-FEVER
"""
import logging
import os
import pickle
...
config = {
    ...
    "train_data": f".data/FEVER/verifier/article_level/train_ret_baseline_shuffled_last25p.jsonl",
    ...
    "save_threshold": 0.58,  # save up some disk space
    ...
    "train_masker": {
        "pretrained_model": ".saved/verifier_A0.7943_S0.7578_R0.9119_B_500_S10000_M.saved_pretrained_debertav3_base_mnli_2022-06-19_13:58_acn29.karolina.it4i.cz",
        "trained_masker": "verifier_A0.7273_S0.0000_R0.0000_B_500_S600_M.saved_pretrained_debertav3_base_mnli_2022-06-21_00:42_acn05.karolina.it4i.cz",
        "top_k": -1,
        "sparsity_weight": 3.,
        "continuity_weight": 0,  # not implemented
        "temperature": "anneal",  # Gumel Softmax Temperature,
        "mask_only_gt": False,
    },
