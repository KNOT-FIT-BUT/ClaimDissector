...
"""
This script trains claim-dissector while performing validation on TLR-FEVER.
"""
BLOCK_SIZE = 500
config = {
    ...
    "save_threshold": 0.70,  # save up some disk space
    ...
    "eval_interp_during_training": True,
