...
"""
Trains DeBERTa base Claim-Dissector with 75% of the training data.
"""
BLOCK_SIZE = 500
config = {
    ...
    "train_data": ".data/FEVER/verifier/article_level/train_ret_baseline_shuffled_first75p.jsonl",
