...
"""
Evaluates roberta-based model on FAVIQ's test set
"""
...
config = {
    ...
    "test_only": True,
    # "model": ".saved_karolina/faviq_verifier_A0.6979_R0.8056_B_500_S10108_Mtextattack_roberta-base-MNLI_2022-11-29_05:11_acn01.karolina.it4i.cz",
    # "model": ".saved_karolina/faviq_verifier_A0.6951_R0.8018_B_500_S8778_Mtextattack_roberta-base-MNLI_2022-11-29_16:59_acn27.karolina.it4i.cz",
    "model": ".saved_karolina/faviq_verifier_A0.6995_R0.8173_B_500_S11970_Mtextattack_roberta-base-MNLI_2022-11-29_18:40_acn10.karolina.it4i.cz",
    ...
    # Data
    ###############################
    "data_cache_dir": ".data/FAVIQ/verifier/preprocessed",
    "train_data": f".data/FAVIQ/evidentiality_dpr/faviq_train_w_evidentiality.jsonl",
    "val_data": ".data/FAVIQ/eval_dpr/faviq_dev.jsonl",
    "test_data": ".data/FAVIQ/eval_dpr/faviq_test.jsonl",
    ...
    "save_threshold": 0.6,  # save up some disk space
    ...
    "xtimesneg": 2,
    "negative_sentence_supervision": True,
