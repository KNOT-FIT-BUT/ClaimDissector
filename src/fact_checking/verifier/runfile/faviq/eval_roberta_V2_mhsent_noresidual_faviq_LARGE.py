...
"""
Evaluates roberta-LARGE-based model on FAVIQ's test set
"""
BLOCK_SIZE = 500
config = {
    "verifier_tokenizer_type": "roberta-large-mnli",
    "verifier_transformer_type": "roberta-large-mnli",
    ...
    "model": ".saved_karolina/faviq_verifier_A0.7329_R0.7835_B_500_S3990_Mroberta-large-mnli_2022-12-01_18:20_acn48.karolina.it4i.cz",
    "test_only": True,
