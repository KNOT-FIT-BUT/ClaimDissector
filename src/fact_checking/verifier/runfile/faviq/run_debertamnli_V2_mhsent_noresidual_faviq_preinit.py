...
"""
Trains deberta-based model on FAVIQ, preinitialized with the model from FEVER
"""
BLOCK_SIZE = 500
config = {
    ...
    "pretrained_reader_model": ".saved/verifier_A0.7998_S0.7652_R0.9145_B_500_S12500_M.saved_pretrained_debertav3_base_mnli_2022-06-02_00:23_acn66.karolina.it4i.cz",
    "pre_initialize": True,
}
