...
"""
Evaluates deberta-based model on FAVIQ's test set
"""
...
config = {
    ...
    "test_only": True,
    "model": ".saved_karolina/faviq_verifier_A0.7606_R0.8213_B_500_S7182_M.saved_pretrained_debertav3_base_mnli_2022-11-29_05:04_acn27.karolina.it4i.cz",
    ...
    "val_data": ".data/FAVIQ/eval_dpr/faviq_test.jsonl",
    ...
    # "write_predictions_faviq": False,
    "dump_top200_not_RSPS_correlated_sampleids": True,  # analyze_rankcorrelation_PS.ipynb
}
